 ...
 * @author swati
 */
public class AddResultPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImageFolder/icons8-clipboard-approve-64.png"))); // NOI18N
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 140, 140, -1));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 135, 129, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 135, 150, 30));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Roll No", "Class", "Section", "Student Name", "Father Name", "Gender"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 200, 732, 76));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 540, -1, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 360, -1, -1));
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 410, -1, -1));

        jTextField5.setBackground(new java.awt.Color(204, 204, 204));
        jTextField5.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jTextField5.setForeground(new java.awt.Color(0, 0, 0));
        jTextField5.setMaximumSize(new java.awt.Dimension(120, 25));
        jTextField5.setMinimumSize(new java.awt.Dimension(120, 25));
        jTextField5.setPreferredSize(new java.awt.Dimension(120, 25));
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 450, -1, -1));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 490, -1, -1));

        jTextField6.setBackground(new java.awt.Color(204, 204, 204));
        jTextField6.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jTextField6.setForeground(new java.awt.Color(0, 0, 0));
        jTextField6.setMaximumSize(new java.awt.Dimension(120, 25));
        jTextField6.setMinimumSize(new java.awt.Dimension(120, 25));
        jTextField6.setPreferredSize(new java.awt.Dimension(120, 25));
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 540, -1, -1));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 320, -1, -1));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 320, 140, -1));

        jButton2.setBackground(new java.awt.Color(204, 204, 204));
        jButton2.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        jButton2.setForeground(new java.awt.Color(0, 0, 0));
        jButton2.setText("SUBMIT");
        jButton2.setMaximumSize(new java.awt.Dimension(95, 32));
        jButton2.setMinimumSize(new java.awt.Dimension(95, 32));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 600, 120, -1));

        jButton3.setBackground(new java.awt.Color(204, 204, 204));
        jButton3.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        jButton3.setForeground(new java.awt.Color(0, 0, 0));
        jButton3.setText("CLOSE");
        jButton3.setMaximumSize(new java.awt.Dimension(95, 32));
        jButton3.setMinimumSize(new java.awt.Dimension(95, 32));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 600, 120, -1));
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(-700, -20, -1, -1));

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImageFolder/classroom.jpg"))); // NOI18N
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 910, 660));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String RollNo=jTextField1.getText();
        int EnglishMarks=Integer.parseInt(jTextField3.getText());
        int HindiMarks=Integer.parseInt(jTextField4.getText());
        int MathematicsMarks=Integer.parseInt(jTextField5.getText());
        int ScienceMarks=Integer.parseInt(jTextField2.getText());
        ...
        try{
            ...
            st.executeUpdate("INSERT INTO result VALUES('"+RollNo+"','"+EnglishMarks+"','"+HindiMarks+"','"+MathematicsMarks+"','"+ScienceMarks+"','"+SSTMarks+"')");
            JOptionPane.showMessageDialog(null,"Successfully Added");
            setVisible(false);
            AddResultPage frame=new AddResultPage();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddResultPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
